    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="#cg" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>采购部 </a>
            <ul id="cg" class="collapse list-unstyled ">
              <li><a href="cgd.html">采购单</a></li>
              <li><a href="cgbb.html">采购报表</a></li>
              <li><a href="cgjl.html">采购记录</a></li>
            </ul>
          </li>
          <li><a href="#wx" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>维修部 </a>
            <ul id="wx" class="collapse list-unstyled ">
              <li><a href="wxd.html">维修单</a></li>
              <li><a href="wxjl.html">维修记录</a></li>
            </ul>
          </li>
          </li>
          <li><a href="#ch" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>策划部 </a>
            <ul id="ch" class="collapse list-unstyled ">
              <li><a href="chd.html">策划单</a></li>
              <li><a href="hdjl.html">活动记录</a></li>
            </ul>
          </li>
      ...
      <div class="content-inner">
        ...
        <header class="page-header">
          <div class="container-fluid">
            <h2 class="no-margin-bottom">账目审批</h2>
          </div>
        </header>
        <!-- Breadcrumb-->
        <div class="breadcrumb-holder container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">账目审批</li>
          </ul>
        </div>
        <section class="forms">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="InsertActivityServlet">
                      <div class="form-group row">
                        <label class="col-sm-1 form-control-label text-right">商品名称</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control text-left" name="spmc">
                        </div>
                        <label class="col-sm-1 form-control-label text-right">价格</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" name="jg">
                        </div>
                        <label class="col-sm-1 form-control-label text-right">数量</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" name="sl">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-1 form-control-label text-right">类型</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control text-left" name="lx">
                        </div>
                      ...
                      <div class="form-group row">
                        <label class="col-sm-1 form-control-label text-right">时间</label>
                        <div class="col-sm-8">
                          <input type="datetime" name="sj">
                        </div>
                      </div>
                       <div class="form-group row">
                      ...
                      <div class="col-sm-1 text-center">
                        <button type="submit" class="btn btn-outline-success"  id="yes"
                        	>确认</button>
                        ${rs}
                      </div>
                      <div class="col-sm-6 text-left">
                        <button type="submit" class="btn btn-outline-warning">上报</button>   
                      </div>
                    </div>
                    </form>
                    <!--提交按钮-->
