        ...
        <div class="container-fluid">
          <div class="navbar-holder d-flex align-items-center justify-content-between">
            ...
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
              ...
              <!-- Logout    -->
              <li class="nav-item"><a href="login.jsp" class="nav-link logout"> <span
    ...
    <div class="page-content d-flex align-items-stretch">
      ...
      <div class="content-inner">
            ...
            <header class="page-header">
              <div class="container-fluid">
                <h2 class="no-margin-bottom">维修记录</h2>
              </div>
            </header>
            <!-- Breadcrumb-->
                      ...
                      <div class="card-body">
                        <div class="table-responsive">
                          <table class="table">
                            ...
                            <tbody> 
                            <c:forEach items="${repairPage.rlist}" var="x">
	                              	 <tr>
	                              		<th scope="row">${x.ri_id}</th>
	                              		<td>${x.ri_name }</td>
	                              		<td>${x.repair_type }</td>
	                              		<td>${x.si_name }</td>
	                              		<td>${x.location }</td>
	                              		<td>${x.ri_time }</td>
	                              		<td id="sta${x.ri_id}">${x.repair_state}</td>
	                              		<td id = "123"><button class="btn btn-outline-success" id="${x.ri_id }">确认</button></td>
	                              	</tr>
                              	</c:forEach>
                            </tbody>
                          </table>
                        ...
                        <ul class="pagination" style="margin-left: 390px">
				            <li class="page-item"><a class="page-link" href="InsertRepairServlet?index=${repairPage.index }">首页</a></li>
				            <li class="page-item"><a class="page-link" href="InsertRepairServlet?index=${repairPage.index-1 }">上一页</a></li>
				            <li class="page-item"><a class="page-link" href="InsertRepairServlet?index=${repairPage.index+1 }">下一页</a></li>
				            <li class="page-item"><a class="page-link" href="InsertRepairServlet?index=${repairPage.pageCount }">尾页</a></li>
				    		<li class="page-link" style="border: 0;margin-left:10px;">共${repairPage.pageCount }页</li>
				        </ul>
                      </div>
                    </div>
                  </div>
 		...
 		var id ;
  		$(function() {
  			$(".btn-outline-success").click(function(){
  				id = $(this).attr('id');
  				$.ajax({
	  				url:"UpdateRepairServlet?uid=" + $(this).attr('id'),
	  				type:"get",
	  				success:function(data){
	  					var count=JSON.parse(data).info;
	  					if(count > 0){
	  						alert("修改成功");
	  						$("#"+id).parent().prev().text("已维修");
	  						$("#"+id).prop("disabled",true).removeClass("btn-outline-success");
	  					}else{
	  						alert("修改失败");
	  					}
  				...
  				/* window.location.href="UpdateRepairServlet?uid=" + $(this).attr('id'); */
  			});
		});
  </script> 
