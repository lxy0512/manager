       ...
       <div class="content-inner">
            ...
            <div class="card-header d-flex align-items-center">
                <div class="table-responsive">
                    ...
                    <a>级会员信息</a>
                    <a class="btn btn-outline-danger" style="margin-left:  1000px;margin-bottom: 5px">新增</a>
                    <table class="table">                        
                    <thead>
                        <tr>
                        <th>#</th>
                    ...
                    <tbody>
                        <tr>
                        <th scope="row">1</th>
                            <td><input type="text" style="border:oldlace;width: 90px;"></td>
                            <td><input type="text" style="border:oldlace;width: 90px;"></td>
                            <td><input type="text" style="border:oldlace;width: 90px;"></td>
                            <td><input type="text" style="border:oldlace;width: 90px;"></td>
                            <td><button><a href="hyxg.html">修改</a></button></td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td><input type="text" style="border:oldlace;width: 90px;"></td>
