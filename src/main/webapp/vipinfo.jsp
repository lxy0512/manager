    ...
    <div class="page-content d-flex align-items-stretch">
      ...
      <div class="content-inner">
            ...
            <header class="page-header">
              <div class="container-fluid">
                <h2 class="no-margin-bottom">会员管理</h2>
              </div>
            </header>
            <!-- Breadcrumb-->
            <div class="breadcrumb-holder container-fluid">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">会员信息修改</li>
              </ul>
            </div>
            ...
            <div class="card-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3"></div>
                        <div class="col-sm-3"></div>
                        <label class="col-sm-1 form-control-label text-right">卡号</label>
                        <div class="col-sm-3" style="margin-bottom: 20px">
                            <input type="text" class="form-control">
                        </div>
                        <div class="col-sm-3" ></div>
                        <div class="col-sm-3" ></div>
                        <label class="col-sm-1 form-control-label text-right">等级</label>
                        <div class="col-sm-3" style="margin-bottom: 20px">
                            <input type="text" class="form-control">
                        </div>
                        <div class="col-sm-3"></div>
                        <div class="col-sm-3"></div>
                        <label class="col-sm-1 form-control-label text-right">折扣</label>
                        <div class="col-sm-3" style="margin-bottom: 20px">
                            <input type="text" class="form-control">
                        </div> 
                        <div class="col-sm-3"></div>
                        <div class="col-sm-3"></div>
                        <label class="col-sm-1 form-control-label text-right">联系方式</label>
                        <div class="col-sm-3" style="margin-bottom: 20px">
                            <input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-6 offset-sm-4">
                        ...
                        &nbsp;
                        <input type="button" value="确定" class="btn btn-secondary">
                    </div>
                  </div>  
                </form>
        </div>
