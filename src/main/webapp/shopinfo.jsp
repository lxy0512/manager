      ...
      <nav class="side-navbar">
       ...
       <div class="content-inner">
            ...
            <header class="page-header">
              <div class="container-fluid">
                <h2 class="no-margin-bottom">店铺管理</h2>
              </div>
            </header>
            <!-- Breadcrumb-->
            <div class="breadcrumb-holder container-fluid">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">店铺信息修改</li>
              </ul>
            </div>
            <div class="card-body">
            <form class="form-horizontal">
                ...
                <div class="form-group row">
                    <label class="col-sm-1 form-control-label text-right">店铺名称</label>
                    <div class="col-sm-3" style="margin-bottom: 5px">
                    <input type="text" class="form-control text-left">
                    </div>
                    <label class="col-sm-1 form-control-label text-right">负责人</label>
                    <div class="col-sm-3" style="margin-bottom: 5px">
                        <input type="text" class="form-control">
                    </div>
                    <label class="col-sm-1 form-control-label text-right">经营商品</label>
                    <div class="col-sm-3" style="margin-bottom: 5px">
                        <input type="text" class="form-control">
                    </div>
                    <label class="col-sm-1 form-control-label text-right">所处位置</label>
                    <div class="col-sm-3" style="margin-bottom: 5px">
                        <input type="text" class="form-control">
                    </div>                     
                    <label class="col-sm-1 form-control-label text-right">经营状态</label>
                    <div class="col-sm-3" style="margin-bottom: 5px">
                        <input type="text" class="form-control">
                    </div>
                    ...
                    <br>
                    <label class="col-sm-1 form-control-label text-right">详情描述</label>
                    <div class="col-sm-9" style="margin-bottom: 5px">
                        <input type="textbox" class="form-control" style="height: 300px">
                    </div>
                </div>
                <div class="col-sm-6 offset-sm-5">
                    <input type="button" value="提交" class="btn btn-secondary">
                    &nbsp;
