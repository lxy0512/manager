    ...
    <div class="page-content d-flex align-items-stretch">
      ...
      <div class="content-inner">
            ...
            <header class="page-header">
              <div class="container-fluid">
                <h2 class="no-margin-bottom">维修单</h2>
              </div>
            </header>
            <!-- Breadcrumb-->
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="card">
                        ...
                        <div class="card-body">
                          <form class="form-horizontal" action="SaveRepairServlet">
                            <div class="form-group row">
                                <label class="col-sm-1 form-control-label text-right">部门</label>
                                <div class="col-sm-3">
                                <input type="text" class="form-control text-left" name="floor">
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-1 form-control-label text-right" >物品名称</label>
                                <div class="col-sm-3">
                                ...
                                <label class="col-sm-1 form-control-label text-right">维修状态</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" value="等待维修" disabled="disabled" name="state">
                                </div>
                                
                            </div>
                                <div class="form-group row">
                                    <label class="col-sm-1 form-control-label text-center">详情</label>
                                    <div class="col-sm-8">
                                      <textarea name="" id="" cols="60" rows="10" name="describe"></textarea>  
                                    </div>
                                    
                                  </div>
                                  <div class="form-group row">
                                <label class="col-sm-1 form-control-label text-center">图片</label>
                                <div class="col-sm-8">
