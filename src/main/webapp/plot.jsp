    ...
    <div class="page-content d-flex align-items-stretch">
      ...
      <div class="content-inner">
            ...
            <header class="page-header">
              <div class="container-fluid">
                <h2 class="no-margin-bottom">策划单</h2>
              </div>
            </header>
            <!-- Breadcrumb-->
            <div class="breadcrumb-holder container-fluid">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">策划单</li>
              </ul>
            </div>
            <section class="forms"> 
                <div class="container-fluid">
                        ...
                        <div class="card-body">
                          <form class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <label class="col-sm-1 form-control-label text-right">开始时间</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control">
                                </div>
                                <label class="col-sm-1 form-control-label text-right">结束时间</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-1 form-control-label text-center">活动类型</label>
                                <div class="col-sm-8">
                                  <input type="text" class="form-control">
                                </div>
                              </div>
