        ...
        <ul class="list-unstyled">
            ...
            <li><a href="#wx" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>维修部
                ...
                <ul id="wx" class="collapse list-unstyled ">
                    ...
                    <li><a href="InsertRepairServlet?index=1">维修记录</a></li>
                </ul>
            </li>
            </li>
        ...
        <ul class="list-unstyled">
            <li><a href="#dp" aria-expanded="false" data-toggle="collapse"> <i class="icon-flask"></i>店铺管理 </a>
                <ul id="dp" class="collapse list-unstyled ">
                    <li><a href="shopmanagerial.jsp">店铺管理</a></li>
                    <li><a href="shopinfo.jsp">店铺信息</a></li>
                </ul>
            </li>
            <li><a href="#hy" aria-expanded="false" data-toggle="collapse"> <i class="icon-mail"></i>会员管理 </a>
                <ul id="hy" class="collapse list-unstyled ">
                    <li><a href="vipmanagerial.jsp">会员管理</a></li>
                    <li><a href="vipinfo.jsp">会员信息</a></li>
                </ul>
            </li>
            <li><a href="#gly" aria-expanded="false" data-toggle="collapse"><i class="icon-picture"></i>管理员中心 </a>
                <ul id="gly" class="collapse list-unstyled ">
                    <li><a href="administratormanagerial.jsp">管理员管理</a></li>
            ...
            <div class="container-fluid">
                    ...
                    <div class="row bg-white has-shadow">
                        <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                            <div class="project-title d-flex align-items-center">
                                <div class="image has-shadow"><img src="img/project-1.jpg" alt="..." class="img-fluid">
                                </div>
                                <div class="text">
                ...
                <div class="project">
                    <div class="row bg-white has-shadow">
                        <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                            <div class="project-title d-flex align-items-center">
                                <div class="image has-shadow"><img src="img/project-2.jpg" alt="..." class="img-fluid">
                                </div>
                                <div class="text">
                                    <h3 class="h4">Project Title</h3>
                                    <small>Lorem Ipsum Dolor</small>
                ...
                <div class="project">
                    <div class="row bg-white has-shadow">
                        <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                            <div class="project-title d-flex align-items-center">
                                <div class="image has-shadow"><img src="img/project-3.jpg" alt="..." class="img-fluid">
                                </div>
                                <div class="text">
                                    <h3 class="h4">Project Title</h3>
                                    <small>Lorem Ipsum Dolor</small>
                ...
                <div class="project">
                    <div class="row bg-white has-shadow">
                        <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                            <div class="project-title d-flex align-items-center">
                                <div class="image has-shadow"><img src="img/project-4.jpg" alt="..." class="img-fluid">
                                </div>
                                <div class="text">
                                    <h3 class="h4">Project Title</h3>
                                    <small>Lorem Ipsum Dolor</small>
                        ...
                        <div class="client card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="client-social d-flex justify-content-between"><a href="#" target="_blank"><i
                                        ...
                                        href="#" target="_blank"><i class="fa fa-google-plus"></i></a><a href="#"
                                                                                                         target="_blank"><i
                                    ...
                                    <div class="feed d-flex justify-content-between">
                                        <div class="feed-body d-flex justify-content-between"><a href="#"
                                            ...
                                            <div class="content">
                                                ...
                                                </i>Like</a><a href="#" class="btn btn-xs btn-secondary"><i
                                                        class="fa fa-heart">
                                                </i>Love </a></div>
                                            </div>
                                        </div>
