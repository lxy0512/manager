                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="table-responsive">
                        	...
                        	<button onclick="window.location.href = 'ListLimitActivityRepairServlet?sindex=${1 } & index=${wx.index }'">首页</button>
                        	<button onclick="window.location.href ='ListLimitActivityRepairServlet?sindex=${(cg.index)-1}& index=${wx.index }'">上一页</button>
                        	<button onclick="window.location.href ='ListLimitActivityRepairServlet?sindex=${(cg.index)+1}& index=${wx.index }'">下一页</button>
                        	<button onclick="window.location.href ='ListLimitActivityRepairServlet?sindex=${cg.allPage}& index=${wx.index }'">尾页</button>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="card-body">
                        <div class="table-responsive">  
                          <table class="table table-striped">
                        	...
                        	<button onclick="window.location.href = 'ListLimitActivityRepairServlet?index=${1 }& index=${cg.index }'">首页</button>
                        	<button onclick="window.location.href ='ListLimitActivityRepairServlet?index=${(wx.index)-1}& index=${cg.index }'">上一页</button>
                        	<button onclick="window.location.href ='ListLimitActivityRepairServlet?index=${(wx.index)+1}& index=${cg.index }'">下一页</button>
                        	<button onclick="window.location.href ='ListLimitActivityRepairServlet?index=${wx.allPage}& index=${cg.index }'">尾页</button>
                        </div>
                      </div>
                    </div>
                  </div>
