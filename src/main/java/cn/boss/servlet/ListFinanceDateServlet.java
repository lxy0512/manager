...
public class ListFinanceDateServlet extends HttpServlet {
...
//		String enddate = request.getParameter("enddate");
		...
		List<Finance> lf = fsi.listFinanceDate(startdate, enddate);
		request.setAttribute("rs", lf);
		request.getRequestDispatcher("accountsstatistics.jsp").forward(request, response);
	}
